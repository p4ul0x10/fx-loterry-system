...
$mode_theme_text = text_color($con);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>FX Loterry - BACKOFFICE</title>
    ...
    <style> 
      ...
      .graph-num{ color: #111224; }
      div p, .dropup button span{ color: #ffffff; }
  ...
  <body class="text-center <?php bg_color(); ?>" onload="main_change();" onresize="main_change();" style="overflow-y: hidden;">
    ...
    <div id="mf0" class="fluid-container w-100 mf" style="height: 800px;">
      ...
      <div role="main" class="col-md-12">
        <main role="main" class="resize-main fluid-container mt-d padding-0">
          ...
          <div class="main-container fluid-container" style="width: 98%;margin: 0px auto !important;">
            <h3 class="text-center card bg-theme text-bold text-light resume-acc">Resume account</h3>
            <div class="col-info-sys col-md-6 float-left card <?php echo $mode_theme_bg[0]; ?> pdg-bo-info">
              <strong class="txt <?php echo $mode_theme_text[0]; ?> ini-top">Total deposited: <a href="#"><?php total_depositado_user(); ?></a><a href="#tdep" class="mg-bo"> <p class="dc text-success float-right acc-amount-d" onclick="tdep('dep');"> <i class="fa fa-angle-up" aria-hidden="true"></i> <?php 
              ...
              <strong class="txt <?php echo $mode_theme_text[0]; ?> ini-top">Total account: <a href="#"><?php total_acc_user(); ?></a><a href="#" class="mg-bo"> <p class="wc text-danger float-right acc-mount-t" onclick="tdep('with');"> <i class="fa fa-angle-down" aria-hidden="true"></i>
              <?php 
              $email = $_SESSION['email'];
              $get_user = mysqli_query($con, "SELECT * FROM usuarios WHERE email ='$email'");
              $array_user = mysqli_fetch_array($get_user);
            ...
            <div class="col-info-sys col-md-6 col-md-6-m3 float-right card <?php echo $mode_theme_bg[0]; ?> pdg-bo-info">
              ...
              <strong class="txt <?php echo $mode_theme_text[0]; ?>">Total return / earns: <a href="#"><?php total_retorno(); ?> </a></strong>
              <button type="button" class="btn bg-theme text-light btnc btnsaque wd float-center">Withdraw</button>
            </div>
            <div class="space-fix-c"></div>
            <h3 id="tkts-line" class="text-center card bg-theme text-bold text-light">FX loterry<i class="fa-fx-question fa fa-question float-right ico-question" aria-hidden="true"></i></h3>
            <div class="col-info-sys col-md-12 float-left card <?php echo $mode_theme_bg[0]; ?>" style="overflow-y: auto !important; overflow-x: hidden !important;">
              ...
              <div class="lt-ys row fluid-container">
                <span class="text-lt <?php echo $mode_theme_text[0]; ?>">Total participants: 
            ...
            <div class="space-fix-cc" id="last-loterries"></div>
            <?php 
            ...
            <div class="col-info-sys col-md-12 float-right card <?php echo $mode_theme_bg[0]; ?>" style="overflow-x: auto !important;">
                  ...
                  <div class="float-left pagination-detail">
                    ...
                    <div class="pg-w float-right pagination">
                      <ul class="pagination float-right">
                        ...
                        <li class="page-item">
                        <?php if($i == 0){ ?>
                          <a id ="w<?php echo $ii; ?>" class="page-nnw page-link bc-theme color-theme <?php echo $mode_theme_bg[0]; ?>" aria-label="to page <?php echo $ii; ?>" href="javascript:void(0)" onclick="pgs('<?php echo "w".$ii; ?>')"><?php echo $ii; ?></a>
                          <?php }else{ ?>
            ...
            <div class="col-md-12 card <?php echo $mode_theme_bg[0]; ?>">
              <strong class="text-center <?php echo $mode_theme_text[0]; ?> mb-3 mt-3">Referral link: <a href='#' target='_new' title='Link de indicação'><?php referencia(); ?></a><i aria-hidden="true" id="copy_link" class="fa fa-files-o fa-1x float-right" onclick="copy_link();" style="position: absolute;margin-top: 4px;margin-left: 8px;"></i>
                </strong>
              ...
              <div class="fluid-container" style="padding: 0px; margin: 0px auto !important;">
                <a href="/backoffice.php?referral=network" class="btn-resources bg-theme btn mb-3 text-light">Network</a>
              ...
              <?php
                ...
                //
                $get_param_ref = $_GET['referral'];
                if($get_param_ref == "network"){
                  $url_ref = "php/ref/return_net_table.php";
                }else if($get_param_ref == "analitics"){
                  $url_ref = "php/ref/return_net_analitics.php";
                }else if($get_param_ref == "banners"){
                  $url_ref = "php/ref/return_net_banners.php";
                }else{
                  $url_ref = "php/ref/return_net_table.php";
                }
                //  
            ...
            <div class="space-fix-cc" id="ref-section"></div>
            <div id="box-menu" class="col-md-12 card <?php echo $mode_theme_bg[0]; ?>">
            <?php include_once ($url_ref); ?>
            </div>
          </div>           
          </div>
          <!-- start footer here -->
      ...
      <?php include_once "php/with/modal-with.php"; ?>
      <?php include_once "php/dep/modal-dep.php"; ?>
      <?php include_once "php/ref/modal-ref.php"; ?>
      <?php include_once "php/not/modal-not.php"; ?>
      <?php include_once "php/lt/modal-lt.php"; ?>
      <?php if(isset($_GET['ref_name'])){ include_once "php/profile/show_users_profile.php"; } ?>
      <?php if(isset($_GET['earns_ref'])){ include_once "php/ref/earns.php"; } ?>
