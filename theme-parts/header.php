...
if($url_page == "/perfil.php"){ 
  $header_current_page = "perfil.php";
}else if($url_page == "/backoffice.php"){
  $header_current_page = "backoffice.php";
}else{
  $header_current_page = "index.php";
} 
?>
...
<header class="masthead mb-auto bg bg-theme" style="z-index: 1; top: 0px;">
  <div class="inner navheader">      
    <nav class="navbar navbar-expand-lg navbar-dark bg-theme">
      <a href="<?php echo $header_current_page; ?>"><img src="images/logofx2.png" alt="fx loterry" class="float-left logo" style="margin-top: 10px;" width="150px" height="45px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <script type="text/javascript">
            $(window).on("load", function(){
              ...
              var get_param = location.href;

              if(get_param.indexOf("/backoffice.php") > 0){
                ...
                //scroll to analitics section  
                if(get_param.indexOf("network") > 0 || get_param.indexOf("analitics") > 0 || get_param.indexOf("banners") > 0){
          ...
          <form class="form-eng form-inline my-2 my-lg-0">
           ...
           <div class="dropdown-menu float-right dd <?php echo $mode_theme_bg[0]; ?>" aria-labelledby="navbarDropdown">
              <span class="dropdown-item lights <?php echo $mode_theme_links[0]; ?> lg-mode" id="#<?php echo $mode_theme_lights[0]; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 512 512"><path fill="currentColor" d="M256 32A224 224 0 0 0 97.61 414.39A224 224 0 1 0 414.39 97.61A222.53 222.53 0 0 0 256 32M64 256c0-105.87 86.13-192 192-192v384c-105.87 0-192-86.13-192-192"></path></svg> Dark / Light</span>
              <a href="#not" class="count-not display-none">+217</a>
              <span class="dropdown-item link-not <?php echo $mode_theme_links[0]; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9m-4.27 13a2 2 0 0 1-3.46 0"></path></svg> Notifications</span>
              ...
              <nav class="nav nav-select-coin">
                <ul class="container-fluid">
                  <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#coin selected">default <img class="img-action-sm" src="images/coins/usdt-sm.png" title="usdt" width="22px" height="22px" alt="usdt coin"></a>
                  </li>
                  <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#btc">bitcoin <img class="img-action-sm" src="images/coins/btc-sm.png" title="bitcoin" width="22px" height="22px" alt="btc coin"></a>
                  </li>
                  <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#eth">ethereum <img class="img-action-sm" src="images/coins/eth-sm.png" title="eth" width="22px" height="22px" alt="eth coin"></a>
                  </li>
                   <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#ltc">litecoin <img class="img-action-sm" src="images/coins/ltc-sm.png" title="eth" width="22px" height="22px" alt="ltc coin"></a>
                  </li>
                  <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#tron">tron <img class="img-action-sm" src="images/coins/trx-sm.png" title="trx" width="22px" height="22px" alt="busd coin"></a>
                  </li>
                   <li class="nav-item choose-coin">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#pix">pix <img class="img-action-sm" src="images/coins/pix.png" title="trx" width="22px" height="22px" alt="busd coin"></a>
                  </li>
                </ul>
              </nav>
            </div>  
              ...
              <nav class="nav nav-select-flag">
                <ul class="container-fluid">
                  <li class="nav-item choose-lang">
                    <a class="dropdown-nav-a nav-link <?php echo $mode_theme_links[0]; ?>" href="#default" onclick="changeLanguage('Português (Brasil)');"><img class="" src="images/flags/br.svg" title="Brazil" width="30px" height="30px" alt="br flags"></a>
                  </li>
                  <li class="nav-item choose-lang">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#ru" onclick="changeLanguage('Russo');"><img src="images/flags/ru.svg" title="Russia" width="30px" height="30px" alt="ru flag"></a>
                  </li>
                   <li class="nav-item choose-lang" onclick="changeLanguage('Inglês');">
                    <a class="nav-link <?php echo $mode_theme_links[0]; ?>" href="#en"><img src="images/flags/gb.svg" title="Inglês" width="30px" height="30px" alt="inglês flag"></a>
                  </li>
                </ul>
              </nav>
            </div>
    ...
    <div class="dropdown-menu dropdown-menu-flags float-right dd <?php if($url_page == "/backoffice.php" || $url_page == "/perfil.php"){ echo $mode_theme_bg[0]; } ?>" aria-labelledby="navbarDropdown" style="overflow-y:auto !important;">
