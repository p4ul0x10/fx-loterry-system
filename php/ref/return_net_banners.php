...
<?php 
	...
	$leader_nome = $array_user['f_nome'];
  	...
  	echo '<br><h6 class="color-theme">300x300 <span><i aria-hidden="true" id="copy_banner1" class="fa fa-files-o fa-1x float-right" onclick="copy_banner1();" style="position: absolute;margin-top: 2;margin-left: 10px;"></i></h6><img src="images/banners/ezgif.com-300.gif" width="300px" height="300px" alt="fx banner 1"><br>';
  ...
  <br><br>';
  	echo '<h6 class="color-theme mt-4">728x90 <span><i aria-hidden="true" id="copy_banner1" class="fa fa-files-o fa-1x float-right" onclick="copy_banner1();" style="position: absolute;margin-top: 2;margin-left: 10px;"></i></h6><img src="images/banners/ezgif.com-728.gif" width="728" height="90px" alt="fx banner 2"><br>';
  ...
  <br><br>';
  	echo '<h6 class="color-theme mt-4">90x90 <span><i aria-hidden="true" id="copy_banner1" class="fa fa-files-o fa-1x float-right" onclick="copy_banner1();" style="position: absolute;margin-top: 2;margin-left: 10px;"></i></h6><img src="images/banners/ezgif.com-90.gif" width="90px" height="90px" alt="fx banner 3"><br>';
