...
class API
{
    ...
    protected $api_key = 'xqUruwzJ01olz5Uno1tCkankGFVaUWzYuKeVKh0qqSIPVSQQWeNwitCfkAbgRxNw'; // /< API key that you created in the binance website member area
    protected $api_secret = 'aTmQcyzEq5xbzj1nQSfpQNf9S2HhjiLE0en64hX3Cm2XKoxo39bIuvCYu1kRdcdj'; // /< API secret that was given to you when you created the api key
    ...
    protected function setupApiConfigFromFile(string $file = null)
    {
        ...
        $this->api_key = 'xqUruwzJ01olz5Uno1tCkankGFVaUWzYuKeVKh0qqSIPVSQQWeNwitCfkAbgRxNw';
        $this->api_secret = 'aTmQcyzEq5xbzj1nQSfpQNf9S2HhjiLE0en64hX3Cm2XKoxo39bIuvCYu1kRdcdj';
